...
export default function CreateBlog({ navigation, route }) {
    ...
    function onUploadImage() {
        launchImageLibrary({
            ...
            if (data?.assets != undefined) {
                ...
                setCoverImg(data.assets[0].uri);
            }
            else setCoverImg(coverImg);
        })
    }
    ...
    async function upladCoverImg(uid) {
        console.log(coverImg, " ccccccccccccccccccccccc")
        if (coverImg != null) {
            ...
            return "https://firebasestorage.googleapis.com/v0/b/blogapp-d3f10.appspot.com/o/Jjzt8MTbR5TLkVQ0cGtuEy1Wr9j1%2Fimages%2Fblog.jpg?alt=media&token=6992a2ff-46f8-4235-8100-df95632cf36c";
        }
    }
    ...
    return (
        <ScrollView
            style={globalStyles.primaryContainer2}
